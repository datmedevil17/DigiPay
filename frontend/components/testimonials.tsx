...
const testimonials = [
  ...
  },
  {
    ...
    avatar: "/placeholder.svg?height=100&width=100",
    content:
      "I recommend BrickByte to my clients who want to add real estate to their investment mix. The platform's transparency, secure technology, and fractional model make it a standout option.",
    rating: 4,
  },
  {
    id: 4,
    ...
    avatar: "/placeholder.svg?height=100&width=100",
    content:
      "The combination of secure technology and AI analytics makes BrickByte truly innovative. I appreciate how they've simplified complex real estate investments into an intuitive platform.",
    rating: 5,
  },
  {
    id: 5,

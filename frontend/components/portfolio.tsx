...
export default function Portfolio() {
  ...
  const handleStakeTokens = (propertyId: string) => {
    toast({
      title: "Coming Soon",
      description: "Token rewards functionality will be available soon.",
    })
  }
              ...
              <CardContent>
                <div className="space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <Card>
                      <CardHeader className="pb-2">
                        <CardTitle className="text-sm font-medium text-muted-foreground">Token Rewards</CardTitle>
                      </CardHeader>
                      <CardContent>
                        <div className="text-2xl font-bold">0.00 USD</div>
                        <p className="text-xs text-muted-foreground">From property token rewards</p>
                      </CardContent>
                    </Card>
                  </div>
                </div>
